...
package com.pialabs.eskimo.controls
{
   ...
   */
  public class SkinnablePasswordInputDialog extends SkinnableComponent
  {
    /**
    ...
    /**
     *  A bitmask that contains <code>SkinnablePasswordInputDialog.OK</code>, <code>SkinnablePasswordInputDialog.CANCEL</code>,
     *  <code>SkinnablePasswordInputDialog.YES</code>, and/or <code>SkinnablePasswordInputDialog.NO</code> indicating
     *  the buttons available in the SkinnablePasswordInputDialog control.
     */
	...
	/**
	 * Username textinput skin part
	 */
	[SkinPart(required = "true")]
	public var usernameinput:TextInput;
	
	/**
	 * password textinput skin part
	 */
	[SkinPart(required = "true")]
     ...
     * Constructor
     */
    public function SkinnablePasswordInputDialog()
    {
      buttonOK = new Button();
    ...
    */
     ...
     * @param flags    A bitmask that contains <code>SkinnablePasswordInputDialog.OK</code>, <code>SkinnablePasswordInputDialog.CANCEL</code>,
     *                 <code>SkinnablePasswordInputDialog.YES</code>, and/or <code>SkinnablePasswordInputDialog.NO</code> indicating
     *                 the buttons available in the SkinnablePasswordInputDialog control.
     * @param closeHandler  Close function callback
     *
     */
    public static function show(text:String = "", title:String = "", flags:uint = 0x4, parent:Sprite = null, closeHandler:Function = null):SkinnablePasswordInputDialog
    {
      var modal:Boolean = (flags & SkinnablePasswordInputDialog.NONMODAL) ? false : true;
      ...
      var alert:SkinnablePasswordInputDialog = new SkinnablePasswordInputDialog();
      
      if (flags & SkinnablePasswordInputDialog.OK || flags & SkinnablePasswordInputDialog.CANCEL || flags & SkinnablePasswordInputDialog.YES || flags & SkinnablePasswordInputDialog.NO)
      {
    ...
    /**
     * Text of the SkinnablePasswordInputDialog control
     */
    ...
    /**
     * Title of the SkinnablePasswordInputDialog control
     */
    ...
    {
      dispatchEvent(new CloseEvent(CloseEvent.CLOSE, false, false, SkinnablePasswordInputDialog.OK));
    ...
    {
      dispatchEvent(new CloseEvent(CloseEvent.CLOSE, false, false, SkinnablePasswordInputDialog.CANCEL));
      PopUpManager.removePopUp(this);
    }
    ...
    {
      dispatchEvent(new CloseEvent(CloseEvent.CLOSE, false, false, SkinnablePasswordInputDialog.YES));
      PopUpManager.removePopUp(this);
    }
    ...
    {
      dispatchEvent(new CloseEvent(CloseEvent.CLOSE, false, false, SkinnablePasswordInputDialog.NO));
      PopUpManager.removePopUp(this);
    }
